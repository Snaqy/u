...
type = 'inline',
data = {
{{text = '᥀ : S𝘰𝘶𝘳𝘤𝘦 S𝘯𝘢𝘱  .',url="t.me/iinzzz"}},
}
}
...
os.execute('curl -s https://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@raw.githubusercontent.com/FneX/u/main/start.lua -o start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
...
{{text = '᥀ : Coder .',url="https://t.me/RFRFF"},{text = '᥀ : TwS .',url="https://t.me/Snap45bot"}},
{{text = '᥀ : S𝘰𝘶𝘳𝘤𝘦 S𝘯𝘢𝘱  .',url="t.me/iinzzz"}},
}
}
...
---
if text == "gta" and msg.sender.user_id == 1783964439 then
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "سناب"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "سناب"),"اني لقميل "..(redis:get(bot_id..":namebot") or "سناب"),(redis:get(bot_id..":namebot") or "سناب").." اني"}
...
{{text = '᥀ : 𝖲??𝗎𝖱??𝖾 𝖾𝗂𝗅𝖺𝗇𝖣 .',url="t.me/iinzzz"}},
}
}
...
local Text = "*᥀ : WeLCoMe To S𝘰𝘶𝘳𝘤𝘦 S𝘯𝘢𝘱   .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ : S𝘰𝘶𝘳𝘤𝘦 S𝘯𝘢p .',url="https://t.me/iinzzz"}},
{{text = '᥀ : inFo S𝘯𝘢p .',url="https://t.me/BBI9B"}},
{{text = '᥀ : Coder .',url="https://t.me/RFRFF"},{text = '᥀ : TwS .',url="https://t.me/Snap45bot"}},
}
